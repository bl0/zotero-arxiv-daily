...
class ArxivPaper:
    ...
    def tldr(self) -> str:
        ...
        llm = get_llm()
        prompt = """Given the title, abstract, introduction and the conclusion (if any) of a paper in latex format, generate a one-sentence TLDR summary in __LANG__, without any other words or phrases:
